<template>
  <div class="col-md-8 nopadding" >
    ...
    <div class="col-md-12 nopadding" v-if="notxt">
      <span>没有找到和“<span style="color: limegreen">{{index}}</span>”有关的攻略</span>
    </div>
    <div class="col-md-12 nopadding card" v-for="travel in travels">
      <div class="col-md-12 nopadding">
        ...
        <div class="col-md-3 img" :style="{background:'url('+travel['scover__url']+')', backgroundSize:cover}"></div>
  ...
  export default {
    ...
    methods: {
      ...
      searchbysome: function () {
        ...
        axios.get('http://127.0.0.1:8000/strategy/searchbysome/' + vm.index + '/')
